...
# app = typer.Typer(help="Survey Classifier CLI - Tag MongoDB survey questions
...
#         ...,
#         help="Collection name containing the questions"
#     ),
#     question_field: str = typer.Option(
#         "question_text",
#         help="Field name containing the question text"
#     )
# ):
#     """
